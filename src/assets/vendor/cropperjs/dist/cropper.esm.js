...
CropperElement.$version = '2.0.0-beta.1';
...
CropperCanvas.$version = '2.0.0-beta.1';
...
class CropperImage extends CropperElement {
    ...
    $transform(a, b, c, d, e, f) {
        if (isNumber(a)
            ...
            // │ b1 d1 f1 │ × │ b2 d2 f2 │
            // └ 0  0  1  ┘   └ 0  0  1  ┘
            return this.$setTransform(a1 * a2 + c1 * b2 /* + e1 * 0 */, b1 * a2 + d1 * b2 /* + f1 * 0 */, a1 * c2 + c1 * d2 /* + e1 * 0 */, b1 * c2 + d1 * d2 /* + f1 * 0 */, a1 * e2 + c1 * f2 + e1 /* * 1 */, b1 * e2 + d1 * f2 + f1 /* * 1 */);
        }
        return this;
    }
    /**
...
CropperImage.$version = '2.0.0-beta.1';
...
CropperShade.$version = '2.0.0-beta.1';
...
CropperHandle.$version = '2.0.0-beta.1';
...
CropperSelection.$version = '2.0.0-beta.1';
...
CropperGrid.$version = '2.0.0-beta.1';
...
CropperCrosshair.$version = '2.0.0-beta.1';
...
CropperViewer.$version = '2.0.0-beta.1';
